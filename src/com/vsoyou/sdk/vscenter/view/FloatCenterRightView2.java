...
public class FloatCenterRightView2 extends LinearLayout implements
		OnClickListener {
	...
	public FloatCenterRightView2(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}

	public FloatCenterRightView2(Context context) {
		super(context);
		initView(context);
	}
