...
public class EmailLayoutView extends BaseLayout {
	...
	protected void onInitUI(Context ctx) {
		...
		edit_phone.setHint("请输入邮箱账号");
		edit_phone.setPadding(MetricUtil.getDip(ctx, 6), MetricUtil.getDip(ctx, 20), 0, MetricUtil.getDip(ctx, 20));
		...
		edit_token.setPadding(MetricUtil.getDip(ctx, 6), MetricUtil.getDip(ctx, 20), 0, MetricUtil.getDip(ctx, 20));
